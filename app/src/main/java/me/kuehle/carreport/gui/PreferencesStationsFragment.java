...
import me.kuehle.carreport.gui.dialog.EditStationDialogFragment;
...
public class PreferencesStationsFragment extends ListFragment implements
        ...
        EditStationDialogFragment.EditStationDialogFragmentListener,
        ...
        public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
            switch (item.getItemId()) {
                case R.id.menu_delete:
                    long[] ids = getListView().getCheckedItemIds();
                    for (long id : ids) {
                        if (StationPresenter.getInstance(getActivity()).isUsed(id)) {
                    ...
                    MessageDialogFragment.newInstance(PreferencesStationsFragment.this, REQUEST_DELETE,
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mListAdapter = new SimpleCursorAdapter(getActivity(), android.R.layout.simple_list_item_activated_2,
                null, new String[]{StationColumns.NAME},
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_add_station:
                EditStationDialogFragment.newInstance(PreferencesStationsFragment.this,
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        EditStationDialogFragment.newInstance(PreferencesStationsFragment.this, REQUEST_EDIT,
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        StationSelection sel = new StationSelection();
        return new CursorLoader(getActivity(), sel.uri(), StationColumns.ALL_COLUMNS, sel.sel(),
            sel.args(), StationColumns.NAME + " COLLATE UNICODE");
    }
