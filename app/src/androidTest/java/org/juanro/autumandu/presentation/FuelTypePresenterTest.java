...
public class FuelTypePresenterTest {
    ...
    public void setUp() throws Exception {
        ...
        Car car2 = new Car("Mixed Car - "+PECULIARITY, 0, 0, null);
        ...
        Refueling ref1 = new Refueling(mCar1Id, mFuelType1Id, new Date(), 55, 4, 5.2f, false, "ref1-"+PECULIARITY);
        Refueling ref2 = new Refueling(mCar1Id, mFuelType2Id, new Date(), 121, 4, 5.8f, false, "ref2-"+PECULIARITY);
        Refueling ref3 = new Refueling(mCar1Id, mFuelType1Id, new Date(), 180, 6, 9.45f, false, "ref3-"+PECULIARITY);
        Refueling ref4 = new Refueling(mCar2Id, mFuelType3Id, new Date(), 68, 4, 5.2f, false, "ref4-"+PECULIARITY);
        Refueling ref5 = new Refueling(mCar2Id, mFuelType3Id, new Date(), 110, 4.2f, 4.6f, false, "ref5"+PECULIARITY);
        Refueling ref6 = new Refueling(mCar2Id, mFuelType2Id, new Date(), 207, 6, 9.45f, false, "ref6-"+PECULIARITY);
    ...
    public void getMostUsedId() {
        ...
        mDB.getRefuelingDao().insert(
                new Refueling(mCar2Id, mFuelType2Id, new Date(), 280, 7, 8.9f, false, "ref7-"+PECULIARITY),
                new Refueling(mCar2Id, mFuelType2Id, new Date(), 355, 6.8f, 8.2f, false, "ref8-"+PECULIARITY));
        assertEquals(mFuelType1Id, ft.getMostUsedId(mCar1Id));
    ...
    public void isUsed() {
        ...
        mDB.getRefuelingDao().insert(
                new Refueling(mCar2Id, mFuelType4Id, new Date(), 240, 4, 3.2f, false, "ref7-"+PECULIARITY));
