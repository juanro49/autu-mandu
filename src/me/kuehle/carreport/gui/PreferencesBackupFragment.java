...
public class PreferencesBackupFragment extends PreferenceFragment implements
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (mCurrentSyncProvider != null) {
			mCurrentSyncProvider.continueAuthentication(requestCode,
					resultCode, data);
		}
	}
	...
	public void onAttach(Activity activity) {
		...
		try {
			((PreferencesActivity) activity).onAttachFragment(this);
	...
	public void onDetach() {
		super.onDetach();
		((PreferencesActivity) getActivity()).onAttachFragment(null);
	}

	@Override
	public void onDialogNegativeClick(int requestCode) {
		if (requestCode == REQUEST_FIRST_SYNC) {
			mCurrentSyncProvider.synchronize(Dropbox.SYNC_UPLOAD);
		}
	}
	...
	public void onDialogPositiveClick(int requestCode) {
		if (requestCode == REQUEST_FIRST_SYNC) {
			mCurrentSyncProvider.synchronize(Dropbox.SYNC_DOWNLOAD);
	...
	private void setupSynchronizationPreference() {
		...
		if (mCurrentSyncProvider != null
			...
			sync.setSummary(getString(
					...
					mCurrentSyncProvider.getAccountName()));
